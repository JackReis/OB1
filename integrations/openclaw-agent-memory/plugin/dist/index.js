...
function isSecretRef(value) {
  const ref = value;
  return !!ref && typeof ref === "object" && (ref.source === "env" || ref.source === "file" || ref.source === "exec") && typeof ref.provider === "string" && ref.provider.length > 0 && typeof ref.id === "string" && ref.id.length > 0;
}
function jsonPointerGet(value, pointer) {
  if (pointer === "") return value;
  if (!pointer.startsWith("/")) return void 0;
  return pointer.slice(1).split("/").map((part) => part.replace(/~1/g, "/").replace(/~0/g, "~")).reduce((current, part) => {
    if (!current || typeof current !== "object") return void 0;
    return current[part];
  }, value);
}
async function resolveFileSecret(ref, provider) {
...
async function resolveAccessKey(config, value) {
  if (typeof value === "string" && value.length > 0) {
    return value;
  }
...
var nullableString = typebox_exports.Union([typebox_exports.String(), typebox_exports.Null()]);
var optionalNullableString = typebox_exports.Optional(nullableString);
var stringArrayRecord = typebox_exports.Record(typebox_exports.String(), typebox_exports.Array(typebox_exports.String()));
var channelParameters = typebox_exports.Object({
  kind: optionalNullableString,
  id: optionalNullableString,
  thread_id: optionalNullableString
});
var runtimeParameters = typebox_exports.Object({
  name: typebox_exports.Optional(typebox_exports.String()),
  version: optionalNullableString
});
var modelIntentParameters = typebox_exports.Object({
  provider: optionalNullableString,
  model: optionalNullableString
});
var recallParameters = typebox_exports.Object({
  schema_version: typebox_exports.Optional(typebox_exports.Union([
    typebox_exports.Literal("openbrain.agent_memory.recall.v1"),
    typebox_exports.Literal("openbrain.openclaw.recall.v1")
  ])),
  workspace_id: typebox_exports.Optional(typebox_exports.String()),
  ...
  channel: typebox_exports.Optional(channelParameters),
  runtime: typebox_exports.Optional(runtimeParameters),
  model_intent: typebox_exports.Optional(modelIntentParameters),
  query: typebox_exports.String(),
  entities: typebox_exports.Optional(stringArrayRecord),
  scope: typebox_exports.Optional(typebox_exports.Object({
    visibility: optionalNullableString,
    project_only: typebox_exports.Optional(typebox_exports.Boolean()),
    include_unconfirmed: typebox_exports.Optional(typebox_exports.Boolean()),
    include_stale: typebox_exports.Optional(typebox_exports.Boolean())
  })),
  limits: typebox_exports.Optional(typebox_exports.Object({
    max_items: typebox_exports.Optional(typebox_exports.Number({ minimum: 1, maximum: 50 })),
    max_tokens: typebox_exports.Optional(typebox_exports.Number({ minimum: 256, maximum: 2e4 })),
    recency_days: typebox_exports.Optional(typebox_exports.Union([typebox_exports.Number({ minimum: 1 }), typebox_exports.Null()]))
  })),
  sensitivity: typebox_exports.Optional(typebox_exports.Record(typebox_exports.String(), typebox_exports.Boolean()))
});
var memoryPayloadParameters = typebox_exports.Object({
  decisions: typebox_exports.Optional(typebox_exports.Array(typebox_exports.String())),
  outputs: typebox_exports.Optional(typebox_exports.Array(typebox_exports.String())),
  lessons: typebox_exports.Optional(typebox_exports.Array(typebox_exports.String())),
  constraints: typebox_exports.Optional(typebox_exports.Array(typebox_exports.String())),
  unresolved_questions: typebox_exports.Optional(typebox_exports.Array(typebox_exports.String())),
  next_steps: typebox_exports.Optional(typebox_exports.Array(typebox_exports.String())),
  failures: typebox_exports.Optional(typebox_exports.Array(typebox_exports.String())),
  artifacts: typebox_exports.Optional(typebox_exports.Array(typebox_exports.Object({
    kind: typebox_exports.String(),
    uri: typebox_exports.String(),
    description: optionalNullableString
  }))),
  entities: typebox_exports.Optional(stringArrayRecord)
});
var writebackParameters = typebox_exports.Object({
  schema_version: typebox_exports.Optional(typebox_exports.Union([
    typebox_exports.Literal("openbrain.agent_memory.writeback.v1"),
    typebox_exports.Literal("openbrain.openclaw.writeback.v1")
  ])),
  workspace_id: typebox_exports.Optional(typebox_exports.String()),
  project_id: optionalNullableString,
  task_id: optionalNullableString,
  ...
  channel: typebox_exports.Optional(channelParameters),
  runtime: typebox_exports.Optional(runtimeParameters),
  models_used: typebox_exports.Optional(typebox_exports.Array(typebox_exports.Object({
    provider: typebox_exports.String(),
    model: typebox_exports.String(),
    role: typebox_exports.String()
  }))),
  source_refs: typebox_exports.Optional(typebox_exports.Array(typebox_exports.Object({
    kind: typebox_exports.String(),
  ...
  provenance: typebox_exports.Optional(typebox_exports.Object({
    default_status: typebox_exports.Optional(typebox_exports.Union([
      typebox_exports.Literal("observed"),
      typebox_exports.Literal("inferred"),
      typebox_exports.Literal("user_confirmed"),
      typebox_exports.Literal("imported"),
      typebox_exports.Literal("generated")
    ])),
    confidence: typebox_exports.Optional(typebox_exports.Number({ minimum: 0, maximum: 1 })),
    requires_review: typebox_exports.Optional(typebox_exports.Boolean())
  })),
  retention: typebox_exports.Optional(typebox_exports.Object({
    ttl_days: typebox_exports.Optional(typebox_exports.Union([typebox_exports.Number({ minimum: 1 }), typebox_exports.Null()])),
    stale_after_days: typebox_exports.Optional(typebox_exports.Union([typebox_exports.Number({ minimum: 1 }), typebox_exports.Null()]))
  })),
  visibility: typebox_exports.Optional(typebox_exports.Object({
  ...
  register(api) {
    ...
    registerTool(api, {
      ...
      parameters: typebox_exports.Object({
        request_id: typebox_exports.String(),
        used_memory_ids: typebox_exports.Optional(typebox_exports.Array(typebox_exports.String())),
        ignored: typebox_exports.Optional(typebox_exports.Array(typebox_exports.Object({
          memory_id: typebox_exports.String(),
          reason: typebox_exports.Optional(typebox_exports.String())
        })))
      }),
    ...
    registerTool(api, {
      ...
      parameters: typebox_exports.Object({ memory_id: typebox_exports.String() }),
    ...
    registerTool(api, {
      ...
      parameters: typebox_exports.Object({
        workspace_id: typebox_exports.Optional(typebox_exports.String()),
        project_id: typebox_exports.Optional(typebox_exports.String())
      }),
    ...
    registerTool(api, {
      ...
      parameters: typebox_exports.Object({
        ...
        action: typebox_exports.Union([
          typebox_exports.Literal("confirm"),
          typebox_exports.Literal("edit"),
          typebox_exports.Literal("evidence_only"),
          typebox_exports.Literal("restrict_scope"),
          typebox_exports.Literal("mark_stale"),
          typebox_exports.Literal("merge"),
          typebox_exports.Literal("reject"),
          typebox_exports.Literal("dispute"),
          typebox_exports.Literal("supersede")
        ]),
        actor_id: typebox_exports.Optional(typebox_exports.String()),
        actor_label: typebox_exports.Optional(typebox_exports.String()),
        notes: typebox_exports.Optional(typebox_exports.String()),
        content: typebox_exports.Optional(typebox_exports.String()),
        summary: typebox_exports.Optional(typebox_exports.String()),
        visibility: typebox_exports.Optional(typebox_exports.String()),
        related_memory_id: typebox_exports.Optional(typebox_exports.String())
      }),
      run: (client, input) => {
    ...
    registerTool(api, {
      ...
      parameters: typebox_exports.Object({ request_id: typebox_exports.String() }),
